 ...
 * Command: /mongoose-os/fw/tools/gen_sys_config.py --c_name=mgos_config --c_global_name=mgos_sys_config --dest_dir=/fwbuild-volumes/2.5.1/apps/smartBatteryBox/esp8266/build_contexts/build_ctx_235236203/build/gen/ /mongoose-os/fw/src/mgos_debug_udp_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_mbedtls_config.yaml /mongoose-os/fw/src/mgos_sys_config.yaml /mongoose-os/fw/platforms/esp8266/src/esp_sys_config.yaml /fwbuild-volumes/2.5.1/apps/smartBatteryBox/esp8266/build_contexts/build_ctx_235236203/build/gen/mos_conf_schema.yml
 */
...
static inline int         mgos_sys_config_get_pins_relayOnboard(void) { return mgos_config_get_pins_relayOnboard(&mgos_sys_config); }
static inline int         mgos_sys_config_get_pins_ACS712(void) { return mgos_config_get_pins_ACS712(&mgos_sys_config); }
...
static inline void mgos_sys_config_set_pins_relayOnboard(int         val) { mgos_config_set_pins_relayOnboard(&mgos_sys_config, val); }
static inline void mgos_sys_config_set_pins_ACS712(int         val) { mgos_config_set_pins_ACS712(&mgos_sys_config, val); }
